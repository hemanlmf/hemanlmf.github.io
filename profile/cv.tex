...
\hspace*{1em} CGPA: 3.90/4.00 \smallskip \\
...
\item Discusses applications in Markov chain Monte Carlo and stochastic gradient method
\end{rSubsection}
...
\begin{rSubsection}{Simulation Run Length Control with Super-optimal Long-run Variance Estimators}{Aug 2021}{JSM 2021}{Speed}
\end{rSubsection}
...
\begin{rSubsection}{Hong Kong Statistical Society}{Jun 2020, Apr 2021}{Statistical Project Competition for Secondary School Students}{Adjudicator}
\end{rSubsection}
