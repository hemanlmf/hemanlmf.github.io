...
2) Variance of estimates is more meaningful in the sense that it measures the accuracy of your estimation procedure. If you are aware of, variance of estimates is the Monte Carlo approximation of $Var(\hat{\theta})$, which gives us the accuracy of $\hat{\theta}$ (assume unbiased)  
