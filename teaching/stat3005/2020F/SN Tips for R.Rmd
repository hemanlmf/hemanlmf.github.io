...
# Introduction
Please follow a more structured guide like Keith's notes if you have no programming experience at all. This short note aims to give some practical tips for R as compared with some common languages that I know.
...
?"for"
```
Looking at the documentation is helpful when we are not sure or forget about how to use some functions. The help manual typically tells us how to use the function, its expected output and provides some examples that we can learn from.
